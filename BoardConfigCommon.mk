...
BOARD_KERNEL_CMDLINE += user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 maxcpus=2 vmalloc=400M
BOARD_KERNEL_CMDLINE += androidboot.write_protect=0 zcache zcache=lz4
